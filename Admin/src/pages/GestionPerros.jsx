  ...
  const handleSubmit = async (datosFormulario) => {
    ...
    if (datosFormulario.foto) {
      ...
      try {
        ...
        console.error("Error al obtener imagen por defecto:", imgError);
        throw new Error("No se pudo cargar la imagen por defecto.");
      }
    }
            ...
            {loadingDetail ? (
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "15px" }}>
                  ...
                  <div>
                    <label style={{ fontSize: "0.85rem", color: "#64748b", display: "block" }}>Estado</label>
                    <span style={{ fontWeight: 600, color: "#334155" }}>
                      {detailData.state === "UNDER_ADOPTION" ? "En Adopción" : detailData.state}
                    </span>
                  </div>
                </div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "10px", color: "#1f2937", fontSize: "0.95rem" }}>
                  <div style={{ display: "flex", justifyContent: "space-between" }}>
                    <span style={{fontWeight: 600}}>Esterilizado:</span> 
                    {detailData.sterilized ? (
                       <span style={{ color: "#16a34a", fontWeight: "bold", backgroundColor: "#dcfce7", padding: "2px 8px", borderRadius: "4px", fontSize: "0.8rem" }}>SÍ</span>
                    ) : (
                      <span>No</span>
                    )}
                  </div>
                  <div style={{ display: "flex", justifyContent: "space-between" }}>
                    <span style={{fontWeight: 600}}>Amputado (Extremidad faltante):</span> 
                    {detailData.missingLimb ? (
                      <span style={{ color: "#ea580c", fontWeight: "bold" }}>SÍ</span>
                    ) : (
                      <span>No</span>
                    )}
                  </div>
                ...
                <div style={{ fontSize: "0.9rem", color: "#475569" }}>
                    <label style={{ fontSize: "0.85rem", color: "#64748b", display: "block", marginBottom: "4px" }}>Descripción inicial</label>
                    <div style={{ fontStyle: "italic", lineHeight: "1.4" }}>
                      "{detailData.initialDescription || "Sin descripción"}"
                    </div>
                </div>
              </div>
            ) : null}
